...
assumed throughout [`DESIGN.md`](DESIGN.md), and it is a different proposal from
the outboard pedal that `DESIGN.md` considered and rejected.
...
[`DESIGN.md`](DESIGN.md) turns down an outboard enclosure on three grounds. Two
...
"Headroom" in [`DESIGN.md`](DESIGN.md), which also records what would falsify it.
